...
public interface PessoaControllerDoc {
    ...
    @PutMapping("/{idPessoa}")
    PessoaOutputDTO update(@Positive @PathVariable("idPessoa") Long id,
    ...
    void delete(@Positive @PathVariable("idPessoa") Long id) throws RegraDeNegocioException, MessagingException;
    ...
    @GetMapping("/{idPessoa}")
    PessoaOutputDTO findById(Long id) throws RegraDeNegocioException;
