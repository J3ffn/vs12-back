...
public interface EnderecoControllerDoc {
    ...
    ResponseEntity<EnderecoOutputDTO> getEnderecoById(@Positive @PathVariable Long idEndereco) throws Exception;
    ...
    ResponseEntity<List<EnderecoOutputDTO>> getEnderecosByIdPessoa(@Positive @PathVariable Long idPessoa);
    ...
    ResponseEntity<EnderecoOutputDTO> create(@Positive @PathVariable Long idPessoa, @Valid @RequestBody EnderecoInputDTO endereco) throws Exception;
    ...
    ResponseEntity<EnderecoOutputDTO> update(@Positive @PathVariable Long idEndereco, @Valid @RequestBody EnderecoInputDTO endereco) throws RegraDeNegocioException, EnumException;
    ...
    void delete(@Positive @PathVariable Long idEndereco) throws Exception;
