...
public interface ContatoControllerDoc {
    ...
    List<ContatoOutputDTO> contatosByIdPessoa(@Positive @PathVariable("idPessoa") Integer idPessoa);
    ...
    ResponseEntity<Void> delete(@Positive @PathVariable("idContato") Integer id) throws RegraDeNegocioException;
